...
bool quadrotor_msgs__msg__trpy_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // pred_input
    PyObject * field = PyObject_GetAttrString(_pymsg, "pred_input");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 4;
      double * dest = ros_message->pred_input;
...
PyObject * quadrotor_msgs__msg__trpy_command__convert_to_py(void * raw_ros_message)
{
  ...
  {  // pred_input
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "pred_input");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    double * src = &(ros_message->pred_input[0]);
