...
class OutputData(metaclass=Metaclass_OutputData):
    ...
    def __init__(self, **kwargs):
        ...
        if 'motor_rpm' not in kwargs:
            self.motor_rpm = numpy.zeros(4, dtype=numpy.int16)
        else:
            self.motor_rpm = kwargs.get('motor_rpm')
    ...
    def __eq__(self, other):
        ...
        if any(self.radio_channel != other.radio_channel):
            return False
        if any(self.motor_rpm != other.motor_rpm):
            return False
    ...
    def motor_rpm(self, value):
        if isinstance(value, numpy.ndarray):
            assert value.dtype == numpy.int16, \
                "The 'motor_rpm' numpy.ndarray() must have the dtype of 'numpy.int16'"
            assert value.size == 4, \
                "The 'motor_rpm' numpy.ndarray() must have a size of 4"
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'motor_rpm' field must be a set or sequence with length 4 and each value of type 'int' and each integer in [-32768, 32767]"
        self._motor_rpm = numpy.array(value, dtype=numpy.int16)
