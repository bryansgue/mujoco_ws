...
bool quadrotor_msgs__msg__rpm_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._rpm_command.RPMCommand", full_classname_dest, 42) == 0);
  }
  quadrotor_msgs__msg__RPMCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // motors
    ...
    }
    {
      ...
      Py_ssize_t size = 4;
      double * dest = ros_message->motors;
      for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * quadrotor_msgs__msg__rpm_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("quadrotor_msgs.msg._rpm_command");
  ...
  {  // motors
    ...
    double * src = &(ros_message->motors[0]);
