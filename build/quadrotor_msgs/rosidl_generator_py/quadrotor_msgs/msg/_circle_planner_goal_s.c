...
bool quadrotor_msgs__msg__circle_planner_goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._circle_planner_goal.CirclePlannerGoal", full_classname_dest, 57) == 0);
  }
  quadrotor_msgs__msg__CirclePlannerGoal * ros_message = _ros_message;
  {  // ax
...
{
  /* NOTE(esteve): Call constructor of CirclePlannerGoal */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("quadrotor_msgs.msg._circle_planner_goal");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CirclePlannerGoal");
