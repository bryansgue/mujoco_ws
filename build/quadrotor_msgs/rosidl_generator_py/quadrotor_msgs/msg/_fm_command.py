...
class FMCommand(metaclass=Metaclass_FMCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.mpc_flag = kwargs.get('mpc_flag', bool())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.mpc_flag != other.mpc_flag:
            return False
    ...
    @builtins.property
    def mpc_flag(self):
        """Message field 'mpc_flag'."""
        return self._mpc_flag

    @mpc_flag.setter
    def mpc_flag(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'mpc_flag' field must be of type 'bool'"
        self._mpc_flag = value
