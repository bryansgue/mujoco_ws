...
bool quadrotor_msgs__msg__position_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // points
    ...
    if (!quadrotor_msgs__msg__TrajectoryPoint__Sequence__init(&(ros_message->points), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create quadrotor_msgs__msg__TrajectoryPoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    quadrotor_msgs__msg__TrajectoryPoint * dest = ros_message->points.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!quadrotor_msgs__msg__trajectory_point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // planner_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "planner_type");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->planner_type = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * quadrotor_msgs__msg__position_command__convert_to_py(void * raw_ros_message)
{
  ...
  {  // points
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = quadrotor_msgs__msg__trajectory_point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // planner_type
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->planner_type);
    {
      int rc = PyObject_SetAttrString(_pymessage, "planner_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
