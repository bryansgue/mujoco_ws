...
class Metaclass_PositionCommand(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'PAYLOAD_PLANNER': cls.__constants['PAYLOAD_PLANNER'],
            'QUAD_PLANNER': cls.__constants['QUAD_PLANNER'],
        }

    @property
    def PAYLOAD_PLANNER(self):
        """Message constant 'PAYLOAD_PLANNER'."""
        return Metaclass_PositionCommand.__constants['PAYLOAD_PLANNER']

    @property
    def QUAD_PLANNER(self):
        """Message constant 'QUAD_PLANNER'."""
        return Metaclass_PositionCommand.__constants['QUAD_PLANNER']
...
class PositionCommand(metaclass=Metaclass_PositionCommand):
    ...
    _fields_and_field_types = {
        ...
        'yaw': 'double',
        'yaw_dot': 'double',
        'points': 'sequence<quadrotor_msgs/TrajectoryPoint>',
        'planner_type': 'int32',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['quadrotor_msgs', 'msg'], 'TrajectoryPoint')),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.planner_type = kwargs.get('planner_type', int())
    ...
    def __eq__(self, other):
        ...
        if self.points != other.points:
            return False
        if self.planner_type != other.planner_type:
            return False
        return True
    ...
    def planner_type(self):
        """Message field 'planner_type'."""
        return self._planner_type

    @planner_type.setter
    def planner_type(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'planner_type' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'planner_type' field must be an integer in [-2147483648, 2147483647]"
        self._planner_type = value
