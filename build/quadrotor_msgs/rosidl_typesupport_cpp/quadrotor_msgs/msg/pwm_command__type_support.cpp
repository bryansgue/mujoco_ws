...
static const _PWMCommand_type_support_symbol_names_t _PWMCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quadrotor_msgs, msg, PWMCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quadrotor_msgs, msg, PWMCommand)),
  }
};
...
{
  return &::quadrotor_msgs::msg::rosidl_typesupport_cpp::PWMCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, quadrotor_msgs, msg, PWMCommand)() {
  return get_message_type_support_handle<quadrotor_msgs::msg::PWMCommand>();
}
