...
static const _RPMCommand_type_support_symbol_names_t _RPMCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quadrotor_msgs, msg, RPMCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quadrotor_msgs, msg, RPMCommand)),
  }
};
...
{
  return &::quadrotor_msgs::msg::rosidl_typesupport_cpp::RPMCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, quadrotor_msgs, msg, RPMCommand)() {
  return get_message_type_support_handle<quadrotor_msgs::msg::RPMCommand>();
}
