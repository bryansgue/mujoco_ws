...
static const _MotorSpeed_type_support_symbol_names_t _MotorSpeed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quadrotor_msgs, msg, MotorSpeed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, quadrotor_msgs, msg, MotorSpeed)),
  }
};
...
{
  return &::quadrotor_msgs::msg::rosidl_typesupport_cpp::MotorSpeed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, quadrotor_msgs, msg, MotorSpeed)() {
  return get_message_type_support_handle<quadrotor_msgs::msg::MotorSpeed>();
}
