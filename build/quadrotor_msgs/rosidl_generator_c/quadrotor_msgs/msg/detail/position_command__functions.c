...
quadrotor_msgs__msg__PositionCommand__init(quadrotor_msgs__msg__PositionCommand * msg)
{
  ...
  // yaw_dot
  // points
  if (!quadrotor_msgs__msg__TrajectoryPoint__Sequence__init(&msg->points, 0)) {
    quadrotor_msgs__msg__PositionCommand__fini(msg);
    return false;
  }
  // planner_type
...
quadrotor_msgs__msg__PositionCommand__fini(quadrotor_msgs__msg__PositionCommand * msg)
{
  ...
  // yaw_dot
  // points
  quadrotor_msgs__msg__TrajectoryPoint__Sequence__fini(&msg->points);
  // planner_type
}
...
quadrotor_msgs__msg__PositionCommand__are_equal(const quadrotor_msgs__msg__PositionCommand * lhs, const quadrotor_msgs__msg__PositionCommand * rhs)
{
  ...
  // points
  if (!quadrotor_msgs__msg__TrajectoryPoint__Sequence__are_equal(
      &(lhs->points), &(rhs->points)))
  {
    return false;
  }
  // planner_type
  if (lhs->planner_type != rhs->planner_type) {
    return false;
  }
  return true;
}
  ...
  quadrotor_msgs__msg__PositionCommand * output)
{
  ...
  // points
  if (!quadrotor_msgs__msg__TrajectoryPoint__Sequence__copy(
      &(input->points), &(output->points)))
  {
    return false;
  }
  // planner_type
  output->planner_type = input->planner_type;
  return true;
}
