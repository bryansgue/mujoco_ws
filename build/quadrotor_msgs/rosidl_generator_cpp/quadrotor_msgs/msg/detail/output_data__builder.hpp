...
class Init_OutputData_motor_rpm
{
public:
  explicit Init_OutputData_motor_rpm(::quadrotor_msgs::msg::OutputData & msg)
  : msg_(msg)
  {}
  Init_OutputData_seq motor_rpm(::quadrotor_msgs::msg::OutputData::_motor_rpm_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_OutputData_motor_rpm radio_channel(::quadrotor_msgs::msg::OutputData::_radio_channel_type arg)
  {
    msg_.radio_channel = std::move(arg);
    return Init_OutputData_motor_rpm(msg_);
  }
