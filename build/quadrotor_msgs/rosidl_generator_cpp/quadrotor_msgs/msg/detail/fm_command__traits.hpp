...
#ifndef QUADROTOR_MSGS__MSG__DETAIL__FM_COMMAND__TRAITS_HPP_
#define QUADROTOR_MSGS__MSG__DETAIL__FM_COMMAND__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "mpc_flag: ";
    rosidl_generator_traits::value_to_yaml(msg.mpc_flag, out);
    out << ", ";
  }
...
inline std::string to_yaml(const FMCommand & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const quadrotor_msgs::msg::FMCommand & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const quadrotor_msgs::msg::FMCommand & msg)
{
  return quadrotor_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<quadrotor_msgs::msg::FMCommand>()
{
  return "quadrotor_msgs::msg::FMCommand";
}

template<>
inline const char * name<quadrotor_msgs::msg::FMCommand>()
{
  return "quadrotor_msgs/msg/FMCommand";
}

template<>
struct has_fixed_size<quadrotor_msgs::msg::FMCommand>
...
template<>
struct has_bounded_size<quadrotor_msgs::msg::FMCommand>
...
template<>
struct is_message<quadrotor_msgs::msg::FMCommand>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // QUADROTOR_MSGS__MSG__DETAIL__FM_COMMAND__TRAITS_HPP_
