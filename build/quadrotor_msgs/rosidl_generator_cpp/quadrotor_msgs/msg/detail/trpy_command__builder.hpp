...
class Init_TRPYCommand_kom
{
public:
  explicit Init_TRPYCommand_kom(::quadrotor_msgs::msg::TRPYCommand & msg)
  : msg_(msg)
  {}
  Init_TRPYCommand_aux kom(::quadrotor_msgs::msg::TRPYCommand::_kom_type arg)
  {
...
class Init_TRPYCommand_kr
{
public:
  explicit Init_TRPYCommand_kr(::quadrotor_msgs::msg::TRPYCommand & msg)
  : msg_(msg)
  {}
  Init_TRPYCommand_kom kr(::quadrotor_msgs::msg::TRPYCommand::_kr_type arg)
  {
    msg_.kr = std::move(arg);
    return Init_TRPYCommand_kom(msg_);
  }
...
{
public:
  explicit Init_TRPYCommand_quaternion(::quadrotor_msgs::msg::TRPYCommand & msg)
  : msg_(msg)
  {}
  Init_TRPYCommand_kr quaternion(::quadrotor_msgs::msg::TRPYCommand::_quaternion_type arg)
  {
    msg_.quaternion = std::move(arg);
    return Init_TRPYCommand_kr(msg_);
  }
...
class Init_TRPYCommand_torque
{
public:
  explicit Init_TRPYCommand_torque(::quadrotor_msgs::msg::TRPYCommand & msg)
  : msg_(msg)
  {}
  Init_TRPYCommand_quaternion torque(::quadrotor_msgs::msg::TRPYCommand::_torque_type arg)
  {
...
{
public:
  explicit Init_TRPYCommand_angular_velocity(::quadrotor_msgs::msg::TRPYCommand & msg)
  : msg_(msg)
  {}
  Init_TRPYCommand_torque angular_velocity(::quadrotor_msgs::msg::TRPYCommand::_angular_velocity_type arg)
  {
    msg_.angular_velocity = std::move(arg);
    return Init_TRPYCommand_torque(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_TRPYCommand_angular_velocity yaw(::quadrotor_msgs::msg::TRPYCommand::_yaw_type arg)
  {
...
class Init_TRPYCommand_pred_input
{
public:
  explicit Init_TRPYCommand_pred_input(::quadrotor_msgs::msg::TRPYCommand & msg)
  : msg_(msg)
  {}
  Init_TRPYCommand_thrust pred_input(::quadrotor_msgs::msg::TRPYCommand::_pred_input_type arg)
  {
    msg_.pred_input = std::move(arg);
...
public:
  ...
  {}
  Init_TRPYCommand_pred_input header(::quadrotor_msgs::msg::TRPYCommand::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_TRPYCommand_pred_input(msg_);
  }
