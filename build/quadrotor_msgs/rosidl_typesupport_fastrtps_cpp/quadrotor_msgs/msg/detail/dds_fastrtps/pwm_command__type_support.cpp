...
#include "quadrotor_msgs/msg/detail/pwm_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const quadrotor_msgs::msg::PWMCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  quadrotor_msgs::msg::PWMCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = quadrotor_msgs::msg::PWMCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const quadrotor_msgs::msg::PWMCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<quadrotor_msgs::msg::PWMCommand *>(
    untyped_ros_message);
...
{
  return &quadrotor_msgs::msg::typesupport_fastrtps_cpp::_PWMCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, quadrotor_msgs, msg, PWMCommand)() {
  return &quadrotor_msgs::msg::typesupport_fastrtps_cpp::_PWMCommand__handle;
}
