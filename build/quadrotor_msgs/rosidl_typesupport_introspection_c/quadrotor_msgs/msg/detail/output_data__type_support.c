...
size_t quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__size_function__OutputData__motor_rpm(
  const void * untyped_member)
{
  (void)untyped_member;
  return 4;
...
const void * quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__get_const_function__OutputData__motor_rpm(
  const void * untyped_member, size_t index)
{
...
void * quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__get_function__OutputData__motor_rpm(
  void * untyped_member, size_t index)
{
  int16_t * member =
...
void quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__fetch_function__OutputData__motor_rpm(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const int16_t * item =
    ((const int16_t *)
    quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__get_const_function__OutputData__motor_rpm(untyped_member, index));
  int16_t * value =
    (int16_t *)(untyped_value);
  *value = *item;
}

void quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__assign_function__OutputData__motor_rpm(
  void * untyped_member, size_t index, const void * untyped_value)
{
  int16_t * item =
    ((int16_t *)
    quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__get_function__OutputData__motor_rpm(untyped_member, index));
  const int16_t * value =
    (const int16_t *)(untyped_value);
  *item = *value;
}

static rosidl_typesupport_introspection_c__MessageMember quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__OutputData_message_member_array[12] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(quadrotor_msgs__msg__OutputData, motor_rpm),  // bytes offset in struct
    NULL,  // default value
    quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__size_function__OutputData__motor_rpm,  // size() function pointer
    quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__get_const_function__OutputData__motor_rpm,  // get_const(index) function pointer
    quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__get_function__OutputData__motor_rpm,  // get(index) function pointer
    quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__fetch_function__OutputData__motor_rpm,  // fetch(index, &value) function pointer
    quadrotor_msgs__msg__OutputData__rosidl_typesupport_introspection_c__assign_function__OutputData__motor_rpm,  // assign(index, value) function pointer
    NULL  // resize(index) function pointer
  },
  {
    "seq",  // name
