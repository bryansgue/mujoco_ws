...
#include "quadrotor_msgs/msg/detail/fm_command__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // angular_velocity, moments
...
using _FMCommand__ros_msg_type = quadrotor_msgs__msg__FMCommand;

static bool _FMCommand__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _FMCommand__ros_msg_type * ros_message = static_cast<const _FMCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: mpc_flag
  {
    cdr << (ros_message->mpc_flag ? true : false);
  }
...
static bool _FMCommand__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _FMCommand__ros_msg_type * ros_message = static_cast<_FMCommand__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: mpc_flag
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->mpc_flag = tmp ? true : false;
  }
...
size_t get_serialized_size_quadrotor_msgs__msg__FMCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FMCommand__ros_msg_type * ros_message = static_cast<const _FMCommand__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name mpc_flag
  {
    size_t item_size = sizeof(ros_message->mpc_flag);
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Vector3(
    &(ros_message->moments), current_alignment);
  // field.name angular_velocity
...
static uint32_t _FMCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_quadrotor_msgs__msg__FMCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quadrotor_msgs
size_t max_serialized_size_quadrotor_msgs__msg__FMCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = quadrotor_msgs__msg__FMCommand;
    is_plain =
      (
...
static size_t _FMCommand__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_quadrotor_msgs__msg__FMCommand(
...
static message_type_support_callbacks_t __callbacks_FMCommand = {
  "quadrotor_msgs::msg",
  "FMCommand",
  _FMCommand__cdr_serialize,
  _FMCommand__cdr_deserialize,
  _FMCommand__get_serialized_size,
  _FMCommand__max_serialized_size
};

static rosidl_message_type_support_t _FMCommand__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FMCommand,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, quadrotor_msgs, msg, FMCommand)() {
  return &_FMCommand__type_support;
}
