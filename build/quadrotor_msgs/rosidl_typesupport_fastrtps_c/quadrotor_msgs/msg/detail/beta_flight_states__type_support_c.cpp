...
#include "quadrotor_msgs/msg/detail/beta_flight_states__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // angular_acceleration_filtered, angular_velocity, linear_acceleration, linear_acceleration_filtered
...
using _BetaFlightStates__ros_msg_type = quadrotor_msgs__msg__BetaFlightStates;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BetaFlightStates__ros_msg_type * ros_message = static_cast<const _BetaFlightStates__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: linear_acceleration_filtered
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->linear_acceleration_filtered, cdr))
    {
      return false;
    }
  }

  // Field name: angular_acceleration_filtered
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->angular_acceleration_filtered, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _BetaFlightStates__ros_msg_type * ros_message = static_cast<_BetaFlightStates__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _BetaFlightStates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_quadrotor_msgs__msg__BetaFlightStates(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = quadrotor_msgs__msg__BetaFlightStates;
    is_plain =
      (
...
static size_t _BetaFlightStates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_quadrotor_msgs__msg__BetaFlightStates(
...
static message_type_support_callbacks_t __callbacks_BetaFlightStates = {
  "quadrotor_msgs::msg",
  "BetaFlightStates",
...
static rosidl_message_type_support_t _BetaFlightStates__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BetaFlightStates,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, quadrotor_msgs, msg, BetaFlightStates)() {
  return &_BetaFlightStates__type_support;
}
