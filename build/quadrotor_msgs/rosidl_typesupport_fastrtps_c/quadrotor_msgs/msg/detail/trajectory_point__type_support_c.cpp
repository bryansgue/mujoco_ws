...
#include "geometry_msgs/msg/detail/point__functions.h"  // acceleration_quad, position, position_quad, velocity_quad
#include "geometry_msgs/msg/detail/quaternion__functions.h"  // quaternion
#include "geometry_msgs/msg/detail/vector3__functions.h"  // acceleration, angular_velocity, angular_velocity_dot, jerk, moments, snap, velocity
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: angular_velocity_dot
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->angular_velocity_dot, cdr))
    {
      return false;
    }
  }
  ...
  // Field name: position_quad
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->position_quad, cdr))
    {
      return false;
    }
  }

  // Field name: velocity_quad
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->velocity_quad, cdr))
    {
      return false;
    }
  }

  // Field name: acceleration_quad
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->acceleration_quad, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: angular_velocity_dot
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->angular_velocity_dot))
    {
      return false;
    }
  }
  ...
  // Field name: acceleration_quad
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->acceleration_quad))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Vector3(
    &(ros_message->angular_velocity_dot), current_alignment);
  // field.name moments
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->position_quad), current_alignment);
  // field.name velocity_quad

  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->velocity_quad), current_alignment);
  // field.name acceleration_quad

  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->acceleration_quad), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, acceleration_quad) +
      last_member_size
      ) == ret_val;
  }
