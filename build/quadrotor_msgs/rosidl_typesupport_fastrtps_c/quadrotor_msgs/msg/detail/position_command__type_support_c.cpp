...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // acceleration, jerk, velocity
#include "quadrotor_msgs/msg/detail/trajectory_point__functions.h"  // points
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, quadrotor_msgs, msg, TrajectoryPoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      quadrotor_msgs__msg__TrajectoryPoint__Sequence__fini(&ros_message->points);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_quadrotor_msgs__msg__TrajectoryPoint(
  ...
  size_t current_alignment)
{
  ...
  // member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_quadrotor_msgs__msg__TrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
