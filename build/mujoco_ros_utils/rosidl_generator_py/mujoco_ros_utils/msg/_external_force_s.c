...
bool mujoco_ros_utils__msg__external_force__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mujoco_ros_utils.msg._external_force.ExternalForce", full_classname_dest, 50) == 0);
  }
  mujoco_ros_utils__msg__ExternalForce * ros_message = _ros_message;
  {  // duration
...
PyObject * mujoco_ros_utils__msg__external_force__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mujoco_ros_utils.msg._external_force");
