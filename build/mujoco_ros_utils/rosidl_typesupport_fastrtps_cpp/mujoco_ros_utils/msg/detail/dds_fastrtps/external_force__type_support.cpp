...
#include "mujoco_ros_utils/msg/detail/external_force__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mujoco_ros_utils::msg::ExternalForce & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mujoco_ros_utils::msg::ExternalForce & ros_message)
{
  // Member: duration
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mujoco_ros_utils::msg::ExternalForce;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mujoco_ros_utils::msg::ExternalForce *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mujoco_ros_utils::msg::ExternalForce *>(
    untyped_ros_message);
...
static size_t _ExternalForce__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ExternalForce(full_bounded, is_plain, 0);
...
{
  return &mujoco_ros_utils::msg::typesupport_fastrtps_cpp::_ExternalForce__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mujoco_ros_utils, msg, ExternalForce)() {
  return &mujoco_ros_utils::msg::typesupport_fastrtps_cpp::_ExternalForce__handle;
}
